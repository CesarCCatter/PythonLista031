...
#formatação float com separador de milhares e decimais em 2 dígitos
print(f"Valor 2: {valor2:,.2f}")
...
# Inclindo R$ antes do valor e substistuindo a vírgula do milhar por underline
texto_valor2 = f"R$ {valor2:_.2f}"
print(f"Texto Valor 2: {texto_valor2}")

#Substituindo o que é ponto por vítgula e o que é underline por ponto
